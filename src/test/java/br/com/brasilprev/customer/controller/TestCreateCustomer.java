...
public class TestCreateCustomer {
	...
	public void testAddCustomer() throws Exception {
		...
		when(customerService.save(customerStub)).thenReturn(customerStub);

		Gson GSON = new Gson();

		mockMvc.perform(MockMvcRequestBuilders.post("/brasilprev/v1/customer")
		...
		verify(customerService).save(customerStub);
